...
laws = 
  ...
  "davis": "Davis' law - In anatomy, describes how soft tissue models along imposed demands. Corollary to Wolff": "Davis' law - In anatomy, describes how soft tissue models along imposed demands. Corollary to Wolff's law."
  ...
  "stefan-boltzmann": "Stefan-Boltzmann law - The total energy radiated per unit surface area of a black body in unit time is directly proportional to the fourth power of the black body": "Stefan-Boltzmann law - The total energy radiated per unit surface area of a black body in unit time is directly proportional to the fourth power of the black body's thermodynamic temperature. Named for Jožef Stefan (1835-1893) and Ludwig Boltzmann."
  ...
  "titius-bode": "Titius-Bode law - \"a hypothesis that the bodies in some orbital systems, including the Sun": "Titius-Bode law - \"a hypothesis that the bodies in some orbital systems, including the Sun's, orbit at semi-major axes in a function of planetary sequence\". Named for Johann Daniel Titius and Johann Elert Bode."
  ...
  "werther": "Werther effect - A spike of emulation suicides after a widely publicized suicide, named after the protagonist of Goethe": "Werther effect - A spike of emulation suicides after a widely publicized suicide, named after the protagonist of Goethe's novel The Sorrows of Young Werther."
